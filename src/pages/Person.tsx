        ...
        >
          ...
          {person.profileUrl ? (
            <motion.img
              ...
              alt={person.name}
              className="w-40 md:w-52 aspect-[2/3] object-cover rounded-2xl shadow-lg mx-auto md:mx-0 ring-1 ring-border"
            />
          ) : (
            <div className="w-40 md:w-52 aspect-[2/3] bg-muted rounded-2xl flex items-center justify-center mx-auto md:mx-0">
          ...
          <div className="flex-1 space-y-4 text-center md:text-left">
            ...
            {person.biography && (
              <div className="space-y-2">
                <p className={`text-muted-foreground leading-relaxed ${!showFullBio ? "line-clamp-4" : ""}`}>
                  {person.biography}
                </p>
          ...
          >
            ...
            <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 gap-3">
              {person.filmography.map((film, index) => (
                ...
                >
                  <div className="aspect-[2/3] rounded-lg overflow-hidden bg-muted shadow-sm group-hover:shadow-lg transition-all ring-2 ring-transparent group-hover:ring-primary">
                    <img
                      src={film.posterUrl}
                      alt={film.title}
