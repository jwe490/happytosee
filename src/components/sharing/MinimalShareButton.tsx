...
export const MinimalShareButton = ({
  ...
  const variantStyles = {
    default: "px-5 py-2.5 h-11 rounded-full bg-accent text-accent-foreground font-medium hover:bg-accent/90",
    outline: "px-5 py-2.5 h-11 rounded-full border border-border bg-transparent hover:bg-muted font-medium",
    minimal: "p-2.5 h-11 w-11 rounded-full hover:bg-muted/80",
  };
