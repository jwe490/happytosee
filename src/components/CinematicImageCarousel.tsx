            ...
            <motion.div key={currentMovie.id} className="max-w-7xl mx-auto px-5 md:px-12 pb-28 md:pb-36" variants={contentVariants} initial="enter" animate="center" exit="exit">
              ...
              <div className="flex items-center gap-3 md:gap-4">
                {/* View Details - opens movie card where trailer plays */}
                  ...
                  className="rounded-xl md:rounded-2xl px-6 md:px-10 h-12 md:h-14 gap-2.5 font-semibold text-sm md:text-base bg-white text-black hover:bg-white/90 shadow-2xl shadow-white/10 transition-all duration-200 hover:scale-[1.02] active:scale-95"
                >
