  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-200 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.97]",
  {
    variants: {
      variant: {
        ...
        outline: "border border-border bg-transparent text-foreground hover:bg-muted hover:border-foreground/50 hover:-translate-y-0.5",
        secondary: "bg-secondary text-secondary-foreground hover:bg-secondary/80 hover:-translate-y-0.5",
        ghost: "text-foreground hover:bg-muted hover:text-foreground",
        link: "text-primary underline-offset-4 hover:underline",
        accent: "bg-accent text-accent-foreground font-semibold hover:bg-accent/90 hover:scale-105 hover:shadow-xl hover:shadow-accent/30",
        glass: "bg-background/80 backdrop-blur-md text-foreground hover:bg-muted/50 border border-border hover:-translate-y-0.5 hover:shadow-lg",
        mood: "bg-secondary text-foreground border border-border hover:border-foreground hover:bg-muted hover:scale-[1.02] hover:shadow-md",
      },
      size: {
