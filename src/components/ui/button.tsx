  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-150 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.96] active:transition-transform active:duration-75",
  {
    variants: {
      variant: {
        ...
        outline: "border border-border bg-transparent text-foreground hover:bg-muted hover:border-foreground/40 hover:-translate-y-0.5",
        ...
        accent: "bg-accent text-accent-foreground font-semibold hover:bg-accent/90 hover:scale-[1.02] hover:shadow-xl hover:shadow-accent/25",
        glass: "bg-card/60 backdrop-blur-xl text-foreground hover:bg-card/80 border border-border/50 hover:-translate-y-0.5 hover:shadow-lg",
        mood: "bg-card/60 backdrop-blur-sm text-foreground border border-border/50 hover:border-foreground/30 hover:bg-card hover:scale-[1.02] hover:shadow-md",
      },
      size: {
